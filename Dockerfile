...
WORKDIR ${GOPATH}/src/github.com/EndercodeLLC/cropsizeme
...
RUN go build -a \
    ...
    github.com/EndercodeLLC/cropsizeme
...
LABEL maintainer="tomas@aparicio.me" \
      ...
      org.label-schema.url="https://github.com/EndercodeLLC/cropsizeme" \
      org.label-schema.vcs-url="https://github.com/EndercodeLLC/cropsizeme" \
